...
if __name__ == "__main__":
    # 테스트용 API 정보 (환경 변수 활용 권장)
    my_key = os.getenv("TWITTER_API_KEY", "your_api_key")
    my_secret = os.getenv("TWITTER_API_SECRET", "your_api_secret")
    my_token = os.getenv("TWITTER_ACCESS_TOKEN", "your_access_token")
    my_token_secret = os.getenv("TWITTER_ACCESS_TOKEN_SECRET", "your_access_token_secret")
